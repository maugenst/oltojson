...
class oltojson extends AbstractToJson {
    /**
    ...
    static convert(html, options) {
        ...
        $(`ol${additionalSelectors}`).each(function(i, ol) {
            const olAsJson = [];
    ...
    static async convertUrl(url, arg1, arg2) {
        ...
        if (typeof arg2 === 'function') {
            ...
            return callback.call(this, oltojson.convert(html, options));
            ...
            requestOptions = options.request || {};
            const html = await AbstractToJson.fetchUrl(url, requestOptions);
            return oltojson.convert(html, options);
        }
    }
...
module.exports = {
    arrayNotEmpty: oltojson.arrayNotEmpty,
    convert: oltojson.convert,
    convertUrl: oltojson.convertUrl
};
